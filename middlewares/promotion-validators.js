 ...
 * 
 * Validaciones para crear, actualizar y obtener promociones
 */
...
export const validateCreatePromotion = (req, res, next) => {
  ...
  // Validar montos
  const amountFields = ['minDepositAmount', 'maxDepositAmount', 'minTransferAmount', 'maxTransferAmount', 'minAccountBalance'];
...
export const validateUpdatePromotion = (req, res, next) => {
  ...
  // Validaciones similares a create pero más permisivas
  ...
  const amountFields = ['minDepositAmount', 'maxDepositAmount', 'minTransferAmount', 'maxTransferAmount', 'minAccountBalance', 'cashbackAmount'];
